...
daftar_telepon(Orang, _, Tanggal),%daftar telepon memiliki nama orang dan tanggal lahir
cek_bulan_ulang_tahun(Bulan_ini, Tanggal),							%ulang tahun yang diketahui dari bulan dan tanggal
cetak_orang(Orang),fail.
yang_ulang_tahun_bulan_ini:-
write("\n\n Tekan sembarang tombol..."),nl,
readchar(_).
cetak_orang(orang(Pertama,Kedua)):-								 %cetak orang dengan nama pertama dan nama kedua jika bulan diambil dari bulan pada sistem komputer
write(" ",Pertama,"\t\t\t ",Kedua),nl.
cek_bulan_ulang_tahun(Bul,tanggal_lahir(_,Bulan,_)):-						%diambil dari bulan pada sistem komputer mengikuti tanggal lahir
konversi_bulan(Bulan,Bulan1),
Bul = Bulan1.
daftar_telepon(orang(erwin,effendy),"767-8463",tanggal_lahir(3,jan,1955)).                    % merupakan daftar telpon terdiri dari nama pertama dan kedua, no telepon dan tanggal lahir
daftar_telepon(orang(pramudya,kurniawan),"438-8400",tanggal_lahir(5,feb,1985)). 	      %tanggal lahir terdiri dari hari, bulan dan tahun
...
konversi_bulan(jun, 6).											%konversi nama bulan ke urutan bulan angka
